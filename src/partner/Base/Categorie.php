...
abstract class Categorie implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\partner\\Map\\CategorieTableMap';
    ...
    /**
     * The value for the categorie_media field.
     *
     * @var        string
     */
    protected $categorie_media;
    ...
    /**
     * Initializes internal state of partner\Base\Categorie object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [categorie_media] column value.
     *
     * @return string
     */
    public function getCategorieMedia()
    {
        return $this->categorie_media;
    }
     ...
     * @return $this|\partner\Categorie The current object (for fluent API support)
     */
    public function setCategorieID($v)
    {
        ...
        if ($this->categorieid !== $v) {
            $this->categorieid = $v;
            $this->modifiedColumns[CategorieTableMap::COL_CATEGORIEID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CategorieTableMap::COL_DESCRIPTION] = true;
        }
    ...
    /**
     * Set the value of [categorie_media] column.
     *
     * @param string|null $v New value
     * @return $this|\partner\Categorie The current object (for fluent API support)
     */
    public function setCategorieMedia($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->categorie_media !== $v) {
            $this->categorie_media = $v;
            $this->modifiedColumns[CategorieTableMap::COL_CATEGORIE_MEDIA] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CategorieTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CategorieTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategorieTableMap::translateFieldName('CategorieID', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategorieTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CategorieTableMap::translateFieldName('CategorieMedia', TableMap::TYPE_PHPNAME, $indexType)];
            $this->categorie_media = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CategorieTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CategorieTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\partner\\Categorie'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategorieTableMap::COL_CATEGORIEID)) {
            $modifiedColumns[':p' . $index++]  = 'categorieId';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = 'libelle';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_CATEGORIE_MEDIA)) {
            $modifiedColumns[':p' . $index++]  = 'categorie_media';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_LAST_UPDATED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'description':
                        ...
                        break;
                    case 'categorie_media':
                        $stmt->bindValue($identifier, $this->categorie_media, PDO::PARAM_STR);
                        break;
                    case 'created_at':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setCategorieMedia($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\partner\Categorie The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategorieTableMap::COL_CATEGORIEID)) {
            $criteria->add(CategorieTableMap::COL_CATEGORIEID, $this->categorieid);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_LIBELLE)) {
            $criteria->add(CategorieTableMap::COL_LIBELLE, $this->libelle);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_DESCRIPTION)) {
            $criteria->add(CategorieTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_CATEGORIE_MEDIA)) {
            $criteria->add(CategorieTableMap::COL_CATEGORIE_MEDIA, $this->categorie_media);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_CREATED_AT)) {
            $criteria->add(CategorieTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_LAST_UPDATED)) {
            $criteria->add(CategorieTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    /**
     * Generic method to set the primary key (categorieid column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \partner\Categorie (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCategorieMedia($this->getCategorieMedia());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \partner\Categorie Clone of current object.
     * @throws PropelException
     */
    ...
    public function initServices($overrideExisting = true)
    {
        ...
        $this->collServices->setModel('\partner\Service');
    }
        ...
        if (null === $this->collServices || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collServices) {
                    ...
                    $collServices->setModel('\partner\Service');
    ...
    public function setServices(Collection $services, ConnectionInterface $con = null)
    {
        ...
        foreach ($servicesToDelete as $serviceRemoved) {
            $serviceRemoved->setCategorie(null);
        }
